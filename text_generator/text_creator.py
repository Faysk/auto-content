...
import re
from text_generator.text_config import PROMPT_PADRAO
from text_generator.text_gerador_api import gerar_texto_ia
from text_generator.text_gerador_local import gerar_texto_local
